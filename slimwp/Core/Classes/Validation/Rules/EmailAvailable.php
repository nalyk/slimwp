...
namespace Slimwp\Core\Classes\Validation\Rules;

use Slimwp\Core\Controllers\AbstractController as c;
 ...
 * new slimwp account (it must be available for the registration
 * to complete).
 *
 ...
 *
 * Used in \Slimwp\Core\Controllers\AuthController:signup_post()
 */
