...
class Profiles extends AbstractTwigController
{
    ...
    {
      $jsf_schema   = file_get_contents(__ROOT__.'/slimwp/Core/Controllers/Schemas/assets.v1.schema');
      $jsf_uischema = file_get_contents(__ROOT__.'/slimwp/Core/Controllers/Schemas/assets.v1.formui');
...
//      url: "https://'.$this->container['settings']['slimwp']['hostname'].$this->container->router->pathFor('assets.api.new').'",


        //$this->container['settings']['slimwp']['hostname']
        //$this->container->settings->slimwp->hostname
