...
require_once (__ROOT__ . '/slimwp/container.php');
require_once (__ROOT__ . '/slimwp/environment.php');
require_once (__ROOT__ . '/slimwp/middleware.php');
require_once (__ROOT__ . '/slimwp/routes.php');
