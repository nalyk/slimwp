...
use Slimwp\Tutorial\Controllers\HomeController;
...
$app->group('/tutorial', function(RouteCollectorProxy $group) {
  $group->get('', function(Request $request, Response $response) { 
        ...
        <body>
          <h1>Slimwp Tutorial</h1> 
          <p style='width: 50%'>This tutorial aims to ease novice PHP developers into basic concepts used throughout Slimwp. Continue <a href='/tutorial/home'>here</a>.<br />Source code for this page: <a href='https://github.com/vaizard/slimwp-skeleton/blob/master/slimwp/Tutorial/routes.php'>slimwp/Tutorial/routes.php</a>.</p>
        </body>
        </html>";
