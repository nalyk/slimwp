...
namespace Slimwp\Contacts\Controllers;

use Carbon\Carbon;
use Slimwp\Core\Classes\Json\JsonResponseBuilder;
...
class ContactsController extends AbstractTwigController
{
    ...
    public function collection_ui(Request $request, Response $response, array $args = []): Response
    {
      ...
      $jsf_schema   = file_get_contents(__ROOT__.'/slimwp/Contacts/Controllers/Schemas/contacts.v1.schema');
      $jsf_uischema = file_get_contents(__ROOT__.'/slimwp/Contacts/Controllers/Schemas/contacts.v1.formui');
      #$jsf_uischema = file_get_contents(__ROOT__.'/slimwp/Contacts/Controllers/Schemas/test.v1.formui');
    ...
    public function addContactForm($request, $response)
    {
        ...
        $jsf_onsubmit = '
            $.ajax({
                url: "https://'.$this->settings['slimwp']['hostname'].$this->routerParser->pathFor('contacts.api.new').'",
                dataType: "text",
                type: "POST",
        ...
        return $this->render($response, 'Core/Views/slimwp.twig', [
            'json_schema_output' => $jsf_schema,
            'json_uischema_output' => $jsf_uischema,
            'json_formdata_output' => $jsf_formdata,
            'json_onsubmit_output' => $jsf_onsubmit,
    ...
    public function me_post(Request $request, Response $response, array $args = []): Response
    {
        ...
        $loader = new \Opis\JsonSchema\Loaders\File("schema://worklog/", [
            __ROOT__ . "/slimwp/Worklog/Controllers/Schemas/",
        ]);
