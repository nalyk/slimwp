...
use DI\Container;
use Slimwp\Core\Classes\Error\HtmlErrorRenderer;
use Slimwp\Core\Middleware\HeadersMiddleware;
use Slimwp\Core\Middleware\LocaleSessionMiddleware;
use Slimwp\Core\Middleware\SessionMiddleware;
use Slimwp\Core\Middleware\Timer;
use Slimwp\Core\Middleware\TranslatorMiddleware;
use Slimwp\Core\Middleware\TwigCspMiddleware;
use Slimwp\Core\Middleware\TwigFlashMiddleware;
use Middlewares\Csp;
...
$app->add(\Slimwp\Core\Middleware\ValidationFormsMiddleware::class);
...
$app->add(new \Slimwp\Core\Middleware\TwigFlashMiddleware($container)); 
...
$app->add(new \Slimwp\Core\Middleware\TwigCspMiddleware($nonce, $container));
...
//$app->add(new \Slimwp\Core\Middleware\AuthorizationMiddleware($container));
